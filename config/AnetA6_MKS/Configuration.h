...
#define STRING_CONFIG_H_AUTHOR "(rjaros87, ANET A6 config for MKS Gen L)" // Who made the changes. //rjaros87
 ...
 */
#define TEMP_SENSOR_0 13 //rjaros87 Hisens 3950  1% up to 300°C for hotend "Simple ONE " & "Hotend "All In ONE"
...
#define TEMP_SENSOR_BED 11 //rjaros87 beta 3950 1% thermistor (4.7k pullup)
...
#define HEATER_0_MAXTEMP 250 //rjaros87 //test
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //rjaros87
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //rjaros87
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE LOW //rjaros87
...
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) //rjaros87
...
#define MESH_BED_LEVELING //rjaros87
 ...
 */
//#define RESTORE_LEVELING_AFTER_G28 //rjaros87 Robert do sprawdzenia te dwie opcje ponizej
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.8  // (mm) Comment out to use the last-measured height //rjaros87 //mozna obnizyc w przyszlosci np. na 0.2
#endif
 ...
 */
#define LCD_BED_LEVELING //rjaros87

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points //rjaros87
#endif

// Add a menu item to move between bed corners for manual bed adjustment
//#define LCD_BED_TRAMMING //rjaros Robert warte do rozwazenia
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //rjaros87
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  //#define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.
  //#define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build. //rjaros87 Robert warte do rozwazenia
#endif
 ...
 */
#define NOZZLE_PARK_FEATURE //rjaros87

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 } //rjaros87
